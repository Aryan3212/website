...
Hi, I'm Aryan. I've spent the last ~4 years working across the stack (frontend, backend, and some infra) in both startups and enterprise SaaS.

I’m not that interested in “busy work”. I like work that has a clear reason to exist and a measurable outcome (users, reliability, cost, growth - any of it, as long as it’s real).

## TL;DR

- Enterprise SaaS + travel tech; shipped product + infra work end-to-end.
- I like ownership, clear metrics, and shipping small wins fast.
...
- Resolved 4 SLA-bound customer issues, saving >$10,000 on each resolved issue
  ...
  {/* PORTFOLIO_PROOF: Add a redacted screenshot of monitoring/logs showing ~1M+ requests/day (or a public proxy metric), plus 1-2 bullets on how you measured it. */}
...
**Other contributions:** Hotel booking review pages, gift card system, remittance admin dashboard with KYC module, email templates for ticket issuance.
    ...
    {/* PORTFOLIO_PROOF: Add a Google Search Console (or analytics) screenshot for 33k -> 116k/month with a date range + note any confounders (seasonality, other initiatives). */}
